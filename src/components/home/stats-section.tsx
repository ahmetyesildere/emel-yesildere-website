...
const StatsSection = () => {
  ...
  const mainStats = [
    ...
    },
    {
      ...
      suffix: '+',
      label: 'Yıl Deneyim',
      description: 'Duygu temizliği alanındaki uzmanlık',
  ...
  const testimonialStats = [
    {
      ...
      percentage: 92,
      description: 'Travma temizliği başarı oranı'
    },
    {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            8 yılı aşkın deneyimimiz ve binlerce mutlu müşterimizle 
