  ...
  const faqs = [
    {
      ...
      answer: 'Randevu almak için birkaç seçeneğiniz var: 1) Web sitemizdeki randevu formunu doldurabilirsiniz, 2) WhatsApp hattımızdan (+90 555 123 4567) mesaj gönderebilirsiniz, 3) Telefon ile arayabilirsiniz, 4) E-posta gönderebilirsiniz. En hızlı yanıt WhatsApp üzerinden alırsınız.',
      category: 'randevu'
    },
    {
      id: 'contact-2',
      question: 'Acil durumda nasıl ulaşabilirim?',
      answer: 'Acil durumlar için WhatsApp hattımız 24/7 aktiftir. +90 555 123 4567 numarasından mesaj gönderebilirsiniz. Acil durum mesajlarına 30 dakika içinde yanıt veriyoruz. Kriz anlarında size destek olmak için buradayız.',
      category: 'acil'
    },
    {
      id: 'contact-3',
    ...
    },
    {
      ...
      answer: 'Güvenlik nedeniyle tam adres randevu alırken SMS ile gönderilir. Ofisimiz İstanbul merkezi lokasyonda, toplu taşıma ile kolayca ulaşılabilir. Randevu saatinden 15 dakika önce detaylı adres bilgisi paylaşılır.',
      category: 'adres'
    },
    {
      id: 'contact-6',
      question: 'Randevumu iptal edebilir miyim?',
      answer: '24 saat önceden iptal edilirse ücret alınmaz. Son dakika iptallerde %50 ücret alınır. Acil durumlar değerlendirilir. İptal için WhatsApp veya telefon ile iletişime geçin.',
      category: 'iptal'
    },
    {
      id: 'contact-7',
            ...
            <Card className="p-6 bg-white border border-gray-200">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">emel@emelyesildere.com</span>
                </div>
                <div className="flex items-center space-x-3">
