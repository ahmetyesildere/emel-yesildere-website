  ...
  const guarantees = [
    {
      ...
      description: 'İlk seanstan memnun kalmazsanız ücret iadesi'
    },
    {
      icon: Users,
      title: '8+ Yıl Deneyim',
    ...
    },
    {
      icon: Star,
      title: '4.9/5 Puan',
      description: '200+ müşteri değerlendirmesi'
    }
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="flex items-center justify-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">+90 555 123 4567</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">emel@emelyesildere.com</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-90">Pzt-Cum: 09:00-18:00</div>
              </div>
            </div>
          </div>
