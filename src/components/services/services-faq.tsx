...
const ServicesFAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Seans süreleri hizmete göre değişir: Yaşam koçluğu 60 dk, Duygu temizliği ve Holistik koçluk 90 dk, Travma iyileştirme 120 dk. İlk seans genellikle daha uzun sürer.',
    ...
    },
    {
      ...
      answer: '24 saat önceden iptal edilirse ücret alınmaz. Son dakika iptallerde %50 ücret alınır. Acil durumlar değerlendirilir ve esnek yaklaşım gösterilir.',
      tags: ['iptal', 'politika', 'ücret']
    }
  ]
