...
const ServicesHero = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Geçmiş travmaların işlenmesi',
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Duygu temizliği, travma iyileştirme ve holistik koçluk hizmetleriyle 
                yaşamınızda kalıcı pozitif değişiklikler yaratın. Her hizmet, 
        ...
        <div className="mt-20 text-center">
          ...
          <Card className="max-w-4xl mx-auto p-6 bg-gradient-to-r from-white/80 to-purple-50/80 backdrop-blur-sm border-2 border-white/50">
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              <strong> 8 yıllık deneyimimle</strong> desteklenir. Amacımız, sadece semptomları değil, 
