...
const SessionsManagement = () => {
  ...
  const serviceTypes = [
    { name: 'Duygu Temizliği', duration: 90, price: 500 },
    { name: 'Travma İyileştirme', duration: 120, price: 750 },
    { name: 'Yaşam Koçluğu', duration: 60, price: 400 },
    { name: 'Holistik Koçluk', duration: 90, price: 600 },
    { name: 'Grup Seansı', duration: 120, price: 200 }
  ]
