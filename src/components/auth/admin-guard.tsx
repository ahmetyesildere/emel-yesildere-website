...
const AdminGuard: React.FC<AdminGuardProps> = ({ children }) => {
  ...
  // Admin email varsa loading'i beklemeden geçir
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Hoş geldiniz, {profile?.first_name || 'Admin'}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Button
  ...
  // Loading state - sadece user yoksa bekle
  if (loading && !user) {
    return (
