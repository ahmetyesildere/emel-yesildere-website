  ...
  const quickActions = [
    {
      ...
      description: '15 dakikalık tanışma görüşmesi',
      icon: '🎯',
      templateType: 'consultation' as const
    },
    {
      id: 'service',
      title: 'Hizmet Bilgisi',
      description: 'Detaylı bilgi almak istiyorum',
      icon: '📋',
      templateType: 'serviceInquiry' as const
    },
    {
      id: 'appointment',
      title: 'Randevu Al',
      description: 'Seans randevusu almak istiyorum',
      icon: '📅',
      templateType: 'appointment' as const
    },
    {
      id: 'general',
      title: 'Genel Sorular',
